...
import { addDocumentsToDossier, getDossierById, updateDossierStatus } from '../services/dossierEtudeService';
import { getUser } from '../utils/auth';

const documentLabels = ["Cahier de charge", "Plan", "CPS", "Ouvrage type", "Note de calcul"];
...
const DossierEtudeDetail = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto p-6 bg-white rounded-xl shadow-lg mt-10">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">📁 Détails du Dossier d'Étude</h2>
